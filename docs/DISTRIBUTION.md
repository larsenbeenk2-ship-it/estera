...
Estera 0.1.0 targets **Apple Silicon Macs running macOS 15 or later**. The native
AppKit/WKWebView shell bundles its Python runtime, web interface and USB backend.
The download is
[Estera-0.1.0-macos-arm64.zip](https://github.com/larsenbeenk2-ship-it/estera/releases/download/v0.1.0/Estera-0.1.0-macos-arm64.zip)
on the [v0.1.0 release](https://github.com/larsenbeenk2-ship-it/estera/releases/tag/v0.1.0).
